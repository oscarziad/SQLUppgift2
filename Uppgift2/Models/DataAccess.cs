...
namespace Uppgift2
{
    public class DataAccess
    {
        ...
        private static string connectionString = @"Server=tcp:azureec.database.windows.net,1433;Initial Catalog=azureec;Persist Security Info=False;User ID=test;Password=Mamma123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
